...
class TestJumpProposals:
    ...
    def test_init_with_params(self, chain_stats_2d):
        ...
        jp = JumpProposals(
            chain_stats_2d, proposal_list=proposal_list, proposal_weights=proposal_weights
        )
...
class TestProposalFunctions:
    ...
    def test_scam_parameter_groups(self):
        ...
        chain_stats = ChainStats(
            ndim=4, pt_state=ptstate, chain_index=0, rng=rng, groups=groups, buffer_size=50
        )
    ...
    def test_de_scale_factors(self):
        ...
        chain_stats = ChainStats(ndim=2, pt_state=ptstate, chain_index=0, rng=rng, buffer_size=20)
