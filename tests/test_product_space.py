...
from impulse.product_space import ProductSpace, NestedProductSpace
...
class TestProductSpace:
    ...
    def test_product_space_init_basic(self):
        ...
        expected_params = ['a_linear', 'b_linear', 'a_quadratic', 'b_quadratic', 'c_quadratic', 'nmodel']
...
class TestNestedProductSpace:
    ...
    def test_nested_product_space_init(self):
        ...
        nps = NestedProductSpace(
            loglikelihood=mock_loglike,
            logprior=mock_logprior,
            num_sources=3,
            num_params=2
        )
