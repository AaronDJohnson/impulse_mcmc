...
class PTPSTestSampler:
    def __init__(self,
                 product_space_model: ProductSpace,
                 buffer_size: int = 50_000,
                 sample_mean: float = None,
                 sample_cov: np.ndarray = None,
                 groups: list = None,
        ...
        self.ntemps = ntemps
        self.swap_steps = swap_steps
        self.lnlike = _function_wrapper(self.pspace.loglikelihood, loglargs, loglkwargs)
        self.lnprior = _function_wrapper(self.pspace.logprior, logpargs, logpkwargs)
