...
:class:`impulse.experimental.birth_death.BirthDeathProductSpace`, which overrides ``get_logprior``
...
class ProductSpace:
    ...
    :class:`impulse.experimental.birth_death.BirthDeathProductSpace` ("N identical sources").
